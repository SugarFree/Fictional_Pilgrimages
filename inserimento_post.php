...
<div id='corpo'>
    <form name='form_csricamento' method='post' enctype='multipart/form-data' action='inserimento_post_script.php '>
        ...
        <input type='text' id='descrizione' name='descrizione'
               placeholder='Inserisci una breve descrizione dell&#8217 opera (facoltativo)'>
        ...
        <input type='text' id='Indirizzo' name='indirizzo'
               placeholder='Inserisci l&#8217 indirizzo in cui è stata scattata la foto'>

        <label for='località'>Località: </label>
        <input type='text' id='località' name='localita'
               placeholder='Inserisci la località in cui è stata scattata la foto'>
