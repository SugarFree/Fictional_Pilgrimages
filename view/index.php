		...
		<a href='ricerca_per_localita.php'><button id='bottone1' type="button">Cerca localit&agrave;</button></a>
		<a href='cerca_opere.php'><button id='bottone2' type="button">Cerca opere</button></a>
